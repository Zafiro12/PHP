...
<body>
    ...
    ?>
        ...
        <form action="index.php" method="post">
            ...
            <span>Aficiones:</span>
            <input type="checkbox" id="futbol" name="aficion[]" value="futbol" <?php if (isset($_POST['aficion']) && estaEnArray('futbol', $_POST['aficion'])) {
                                                                                    echo 'checked';
                                                                                } ?>><label for="futbol">Futbol</label>
            <input type="checkbox" id="tenis" name="aficion[]" value="tenis" <?php if (isset($_POST['aficion']) && estaEnArray('tenis', $_POST['aficion'])) {
                                                                                    echo 'checked';
                                                                                } ?>><label for="tenis">Tenis</label>
            <input type="checkbox" id="baloncesto" name="aficion[]" value="baloncesto" <?php if (isset($_POST['aficion']) && estaEnArray('baloncesto', $_POST['aficion'])) {
                                                                                            echo 'checked';
