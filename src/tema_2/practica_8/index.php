    ...
    if ($result = mysqli_query($link, $sql)) {
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($fieldinfo = mysqli_fetch_field($result)) {
                // Solo se muestra id, nombre y foto
                if ($fieldinfo->name == "id_usuario" || $fieldinfo->name == "nombre" || $fieldinfo->name == "foto") {
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                echo "<td>";
                echo "<a href='delete.php?id=" . $row['id_usuario'] . "'><img src='" . $enlaces[0] . "' width='20px' height='20px'></a>" . PHP_EOL;
                echo "<a href='update.php?id=" . $row['id_usuario'] . "'><img src='" . $enlaces[1] . "' width='20px' height='20px'></a>" . PHP_EOL;
                echo "<a href='view.php?id=" . $row['id_usuario'] . "'><img src='" . $enlaces[2] . "' width='20px' height='20px'></a>" . PHP_EOL;
                echo "</tr>";
            }
            echo "</table>";
