const DIR_SERV =
    "http://localhost/tema_5/practica_2/Ejercicio1_key/servicios_rest_ejer1";
...
function cargar_vista_login(error) {
    ...
    html_output +=
        "<p><label for='usuario'>Usuario: </label><input type='text' id='usuario' required/></p>";
    html_output +=
        "<p><label for='clave'>Contraseña: </label><input onkeyup='cifrar_clave();' type='password' id='clave' required/><input id='clave2' type='hidden'/></p>";
